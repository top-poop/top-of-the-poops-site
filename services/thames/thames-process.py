...
from calendar_bucket import Calendar, Summariser
...
if __name__ == "__main__":
    ...
    parser.add_argument("--state", type=pathlib.Path, default=pathlib.Path("api/twstate.png"), help="Write state transitions to file")
    ...
    with psycopg2.connect(host=db_host, database="gis", user="docker", password="docker") as conn:
        ...
        for permit_id, calendar in csos.things_at(now):
