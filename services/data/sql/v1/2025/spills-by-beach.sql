...
from bathing_view this
         left join bathing_view as last on upper(this.bathing) = upper(last.bathing) and this.company_name = last.company_name and last.reporting_year = 2024
where
    this.reporting_year = 2025
