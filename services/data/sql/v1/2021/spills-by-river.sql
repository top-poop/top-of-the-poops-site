with reports_2020 as (
    ...
    where reporting_year = 2020 and rec_env_code_description in ( 'Canal', 'Estuary/Tidal River', 'Freshwater river')
...
where
   reports_2020.total_hours > 24 or reports_2021.total_hours > 24
